...
CREATE TABLE GESTION_CENTROS.PC_DELEGACIONES_DETALLES (
    ...
    SUPERFICIE NUMERIC(6, 4) NOT NULL,
    PUESTOS_DISPONIBLES INT,
    ACCESIBILIDAD BOOLEAN DEFAULT TRUE NOT NULL,
    PLAZAS_GARAJE BOOLEAN DEFAULT TRUE NOT NULL,
    NUM_PLAZAS_GARAJE INT,
    DESCRIPCION VARCHAR(500),
    TODOS_DPTOS BOOLEAN DEFAULT TRUE NOT NULL,
