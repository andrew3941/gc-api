...
-- PROVIDERS
ALTER TABLE GESTION_CENTROS.PROVEEDORES ADD COLUMN TODOS_CENTROS BOOLEAN;
UPDATE GESTION_CENTROS.PROVEEDORES SET TODOS_CENTROS = FALSE;
ALTER TABLE PROVEEDORES ALTER COLUMN PERSONA_CONTACTO DROP NOT NULL;
ALTER TABLE PROVEEDORES DROP COLUMN AREA_ID;
